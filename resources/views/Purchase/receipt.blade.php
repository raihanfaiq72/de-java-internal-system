                    ...
                    <div class="col-sm-12">
                        <div class="page-title-box d-md-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="text-muted mb-0 small">Kelola kuitansi dan riwayat pembayaran kepada
                                    supplier/vendor.</p>
                            </div>
                ...
                <div class="modal-body p-4">
                    <form id="form-receipt" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h6 class="fw-bold m-0"><i class="fa fa-file-invoice text-primary me-2"></i>Rincian Tagihan
                                Pembelian</h6>
                            ...
                            <table class="table table-hover align-middle mb-0" id="table-selected-invoices">
                                <thead class="bg-light">
                                    <tr>
                                        ...
                                        <th class="small fw-bold text-muted py-3 text-end pe-3" width="200">Jumlah Terbayar
                                        </th>
                                    </tr>
                                </thead>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-4">
                                <label class="form-label fw-bold text-muted small d-block">Bukti Pembayaran
                                    (Opsional)</label>
...
@push('js')
    ...
    <script>
        ...
        async function submitReceipt(action) {
            ...
            if (!akunId) {
                alert('Pilih Akun Keuangan (Diambil Dari) terlebih dahulu!');
                return;
            }
            ...
            try {
                ...
                for (const inv of selectedInvoices) {
                    if (inv.bayar > 0) {
                        ...
                        const metode = document.getElementById('metode_pembayaran') ? document.getElementById('metode_pembayaran').value : 'Cash';
                ...
                else { alert('Gagal menyimpan beberapa data.'); }
