...
header("Content-Disposition: attachment; filename=Purchases_Invoices_" . date('Y-m-d') . ".xls");
?>
<!DOCTYPE html>
<html>
...
<head>
    <meta charset="utf-8">
    <title>Purchases Invoices</title>
    <style>
        table {
            width: 100%;
        ...
        <tbody>
            @foreach($invoices as $index => $invoice)
                ...
                <tr>
                    ...
                    <td>{{ $invoice->tgl_jatuh_tempo ? \Carbon\Carbon::parse($invoice->tgl_jatuh_tempo)->format('d M Y') : '-' }}
                    </td>
