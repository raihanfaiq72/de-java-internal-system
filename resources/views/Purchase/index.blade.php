        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center mb-4">
                <div class="col-md-7">
                    ...
                    <p class="text-muted small mb-0">Kelola tagihan supplier dan pantau hutang usaha secara real-time.</p>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card border-0 shadow-sm rounded-3">
                        <div class="card-body p-3 border-start border-4 border-primary">
                            <label class="f-label">Total Hutang</label>
                            <h5 class="fw-bold mb-0 text-dark">Rp 320.000.000</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="card border-0 shadow-sm rounded-3">
                        <div class="card-body p-3 border-start border-4 border-danger">
                            ...
                            <h5 class="fw-bold mb-0 text-danger">5 Dokumen</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="card border-0 shadow-sm rounded-3">
                        <div class="card-body p-3 border-start border-4 border-success">
                            ...
                            <h5 class="fw-bold mb-0 text-success">Rp 85.000.000</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="card border-0 shadow-sm rounded-3">
                        <div class="card-body p-3 border-start border-4 border-secondary">
                            <label class="f-label">Total Pembelian</label>
                            <h5 class="fw-bold mb-0 text-dark">840 Item</h5>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row g-2 mb-4 p-3 rounded-3 align-items-end bg-light border">
                                <div class="col-lg-3">
                                    ...
                                    <div class="input-group input-group-finance">
                                        ...
                                        <input type="text" id="filter-search" class="form-control border-start-0 ps-0 shadow-none" placeholder="No. Invoice / Supplier...">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                ...
                                <table class="table table-hover align-middle mb-0" id="invoiceTable">
                                    <thead class="bg-light text-uppercase text-secondary fw-bold" style="font-size: 11px; letter-spacing: 0.5px;">
                                        <tr>
                                            ...
                                            <th width="200">Supplier/Vendor</th>
                                            <th width="120" class="text-center">Status</th>
                                            <th width="150" class="text-end">Jumlah</th>
                                            <th width="150" class="text-end">Hutang</th>
                     ...
                     <td class="text-end pe-3" onclick="event.stopPropagation()">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-finance">
                                ...
                                <li><a class="dropdown-item" href="{{ url('purchase/print') }}/${item.id}" target="_blank"><i class="fa fa-print text-dark me-2"></i> Cetak Nota</a></li>
                ...
                <tr class="detail-row">
                    <td colspan="10" class="p-0">
                        <div class="collapse detail-wrapper" id="detail-${item.id}">
                            <div class="p-4">
                                <h6 class="fw-bold text-uppercase text-secondary small mb-3"><i class="fa fa-list me-2"></i>Rincian Item Pembelian</h6>
