...
<body>
    ...
    <div class="nota-container" id="nota-content" style="display: none;">
        ...
        <table class="main-table">
            <thead>
                <tr>
                    <th width="5%">NO</th>
                    <th width="12%" style="font-size: 10px;">KODE</th>
            ...
            <tfoot>
                <tr>
                    <td colspan="5" rowspan="6"
                        ...
                        <div style="font-style: italic; font-size: 10px; display: none;">
    ...
    <template id="item-row-template">
        <tr>
            ...
            <td class="text-center col-kode" style="font-size: 10px;"></td>
            ...
            try {
                ...
                if (result.success) {
                    ...
                    data.items.forEach((item, index) => {
                        ...
                        clone.querySelector('.col-kode').textContent = p.supplier?.nomor_mitra || '-';
                        ...
                        clone.querySelector('.col-harga').textContent = formatNumber(item
                            .harga_satuan || item.harga_jual || item.harga_beli || 0);
                        let discText = '-';
                    ...
                    for (let i = data.items.length; i < 13; i++) {
                    ...
                    // document.getElementById('biaya_lain_display').innerText = formatNumber(data.other_fee || data.biaya_kirim || 0);
                    ...
                    // document.getElementById('terbilang_display').innerText = terbilang(data.total_akhir) + " RUPIAH";
