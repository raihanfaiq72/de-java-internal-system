                    ...
                    <div class="slip-box">
                        ...
                        <table class="table-earnings">
                            ...
                            <tr>
                                ...
                                <td class="col-calc">RP.
                                    {{ number_format($salarySlip->details['daily_rate'] ?? 50000, 0, ',', '.') }} x
                                    {{ $salarySlip->details['work_days'] ?? 0 }}(HARI)</td>
                                <td class="col-eq">=</td>
                                <td class="col-amount">Rp. {{ number_format($salarySlip->basic_salary, 0, ',', '.') }}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="col-eq">=</td>
                                <td class="col-amount">Rp. {{ number_format($salarySlip->meal_allowance, 0, ',', '.') }}
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table class="box-total">
                            <tr class="row-total">
                                ...
                                <td style="width: 25%;">Rp. {{ number_format($salarySlip->total_salary, 0, ',', '.') }}
                                </td>
                            </tr>
                            <tr>
                        ...
                        @php
                            ...
                            $date = Carbon\Carbon::parse($salarySlip->salaryPeriod->end_date)->translatedFormat(
                                'l, d F Y',
                            );
                        @endphp
                ...
                @foreach ($chunk as $salarySlip)
                    ...
                    <table class="table-earnings">
                        ...
                        <tr>
                            ...
                            <td class="col-calc"></td>
                            <td class="col-eq">=</td>
                            <td class="col-amount">Rp. {{ number_format($salarySlip->other_deduction, 0, ',', '.') }}
                            </td>
                        </tr>
                    </table>
