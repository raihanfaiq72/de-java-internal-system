                        ...
                        <form action="{{ route('report.cash-book') }}" method="GET" class="row align-items-end g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="date" name="start_date" class="form-control py-2" value="{{ request('start_date', $start->toDateString()) }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label fw-bold text-muted small text-uppercase mb-2">SAMPAI TANGGAL</label>
                                <div class="input-group">
                                    <input type="date" name="end_date" class="form-control py-2" value="{{ request('end_date', $end->toDateString()) }}">
                                </div>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-2 text-end ms-auto">
                                <button type="button" onclick="window.print()" class="btn btn-white border fw-bold w-100 py-2 shadow-sm text-dark d-flex align-items-center justify-content-center">
                ...
                <div class="card border-0 shadow-none bg-white">
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-sm w-100" style="border: 2px solid #000; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 12px; color: #000;">
                                <thead>
                                    <!-- Title Row -->
                                    <tr style="background-color: #fff; border: 1px solid #000;">
                                        <th colspan="7" class="text-center py-3" style="border: 1px solid #000; font-size: 16px; font-weight: bold; text-transform: uppercase; color: #000;">
                                            LAPORAN KAS BESAR {{ $officeName }}<br>
                                            <span style="font-size: 12px; font-weight: bold;">PERIODE {{ \Carbon\Carbon::parse($start)->translatedFormat('d F Y') }} - {{ \Carbon\Carbon::parse($end)->translatedFormat('d F Y') }}</span>
                                        </th>
                                    </tr>
                                    <!-- Column Headers -->
                                    <tr style="background-color: #C0504D; color: #000; border: 1px solid #000;">
                                        <th class="text-center align-middle py-2" style="border: 1px solid #000; width: 40px; font-weight: bold;">No</th>
                                        <th class="text-center align-middle py-2" style="border: 1px solid #000; width: 90px; font-weight: bold;">Tanggal</th>
                                        <th class="text-center align-middle py-2" style="border: 1px solid #000; width: 120px; font-weight: bold;">Nama Akun</th>
                                        <th class="text-center align-middle py-2" style="border: 1px solid #000; font-weight: bold;">Keterangan</th>
                                        <th class="text-center align-middle py-2" style="border: 1px solid #000; width: 110px; font-weight: bold;">Debit</th>
                                        <th class="text-center align-middle py-2" style="border: 1px solid #000; width: 110px; font-weight: bold;">Kredit</th>
                                        <th class="text-center align-middle py-2" style="border: 1px solid #000; width: 130px; font-weight: bold;">Total Saldo</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($rows as $i => $r)
...
@push('css')
    <style>
        @media print {
            ...
            tr.d-print-table-row { height: auto !important; }
