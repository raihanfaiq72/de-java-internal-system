    ...
    <div class="card-header bg-white border-bottom py-3 px-4 d-flex flex-wrap justify-content-between align-items-center gap-3">
        ...
        <div class="d-flex align-items-center gap-2">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow p-2 colToggleMenu" data-target="#table-invoice-products" style="min-width: 200px; max-height: 450px; overflow-y: auto; z-index: 100000;">
        ...
        <table class="table table-hover align-middle mb-0" id="table-invoice-products">
            <thead class="bg-light">
                ...
                <tr>
                    ...
                    <th class="py-3 text-muted small fw-bold text-uppercase cursor-pointer sortable" data-sort="products.nama_produk">
                        Produk
                    ...
                    <th class="text-end py-3 text-muted small fw-bold text-uppercase cursor-pointer sortable" data-sort="invoice_items.harga_satuan">
                        Harga
                    ...
                    <th class="text-end py-3 text-muted small fw-bold text-uppercase cursor-pointer sortable" data-sort="invoice_items.diskon_nilai">
                        Disc. Item
                    ...
                    <th class="text-end py-3 text-muted small fw-bold text-uppercase cursor-pointer sortable" data-sort="total_diskon">
                        Tot. Disc
                    ...
                    <th class="px-4 py-3 text-muted small fw-bold text-uppercase text-end cursor-pointer sortable" data-sort="total_akhir">
                        Total Akhir
                ...
                @forelse($invoiceItems as $item)
                    <tr>
                        <td class="px-4">
                            ...
                            @endphp
                            <span class="badge bg-soft-{{ $statusClass }} text-{{ $statusClass }} border border-{{ $statusClass }} border-opacity-25 rounded-pill px-2 py-1">
                        ...
                        <td class="fw-bold">
                            <a href="{{ $item->tipe_invoice === 'Sales' ? route('sales.show', $item->invoice_id) : route('purchase.show', $item->invoice_id) }}" class="text-primary text-decoration-none">
                                {{ $item->nomor_invoice }}
                            </a>
                        </td>
