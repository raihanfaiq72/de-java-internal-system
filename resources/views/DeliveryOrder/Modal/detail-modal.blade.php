    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-footer border-top-0 pt-0 pb-4 px-4">
                ...
                <a href="#" target="_blank" id="btn_print_do" class="btn btn-dark fw-bold">
...
<script>
    async function openDetailDOModal(id) {
        ...
        document.getElementById('detailInvoiceTable').querySelector('tbody').innerHTML = '<tr><td colspan="5" class="text-center py-4"><div class="spinner-border spinner-border-sm"></div></td></tr>';
        ...
        try {
            ...
            if (data.invoices && data.invoices.length > 0) {
                ...
                tbody.innerHTML = '<tr><td colspan="5" class="text-center py-3 text-muted fst-italic">Tidak ada invoice terlampir.</td></tr>';
            }
