<div class="modal fade" id="deliveryOrderModal" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content border-0" style="background-color: #f8fafc;">
            ...
            <div class="modal-header bg-white border-bottom px-4 py-3 sticky-top shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="text-muted small mb-0">Kelola delivery order.</p>
                    </div>
                </div>
                <div class="ms-auto d-flex align-items-center gap-3">
                    <button type="button" class="btn btn-light border text-secondary fw-semibold px-4"
                        data-bs-dismiss="modal">Tutup</button>
                    <button type="button" class="btn btn-primary px-4 fw-bold shadow-sm" onclick="()">
            ...
            <div class="modal-body p-0">
                <form id="deliveryOrderForm" class="h-100">
                    <input type="hidden" id="form_mode" value="create">
                    <input type="hidden" id="edit_delivery_order_id" value="">
...
<script>
    async function openDeliveryOrderModal(id = null, type = null, mode = 'create') {
