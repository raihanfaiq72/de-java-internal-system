<div class="tab-pane fade" id="tab-kategori-produk" role="tabpanel">
    ...
    <div class="row g-2 mb-3 align-items-end">
        <div class="col-md-3">
            ...
            <input type="text" id="filter-kategori-search" class="form-control form-control-sm"
                placeholder="Nama kategori...">
        </div>

        <div class="col-md-auto">
            <button onclick="loadKategoriProduk()" class="btn btn-sm btn-dark px-3">
                <i class="fa fa-filter me-1"></i> Filter
            </button>
        </div>

        <div class="col text-end">
            <button class="btn btn-sm btn-primary px-3 shadow-sm" onclick="tambahKategori()">
    ...
    <script>
        ...
        async function loadKategoriParentOption() {
            ...
            try {
                ...
                if (tomSelectKategoriParent) {
                    tomSelectKategoriParent.sync();
                }
            } catch (error) {
                console.error("Gagal memuat opsi parent", e);
            }
        }
        ...
        async function editKategori(id) {
            ...
            if (tomSelectKategoriParent) {
                tomSelectKategoriParent.setValue(data.parent_id ?? '');
            } else {
                document.getElementById('kategori-parent').value = data.parent_id ?? '';
            }
