                    ...
                    <div class="row g-0 h-100">
                        ...
                        <div class="col-lg-9 h-100 overflow-auto custom-scrollbar p-4">
                                ...
                                <div class="card-body p-4">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-6 border-end">
                                            <label class="f-label mb-2">Pelanggan / Mitra <span class="text-danger">*</span></label>
                                            <select id="modal_mitra_id" class="form-select f-input-lg mb-3" onchange="renderMitraDetail()">
                                            ...
                                            <div id="mitra_detail_display" class="d-none bg-light p-3 rounded border">
                                                ...
                                                <div class="small text-muted mb-1"><i class="fa fa-map-marker-alt me-2 text-secondary"></i><span id="disp_mitra_alamat">-</span></div>
                                                <div class="small text-muted"><i class="fa fa-phone me-2 text-secondary"></i><span id="disp_mitra_telp">-</span></div>
                                            </div>
                                            <div id="mitra_empty_state" class="text-center py-4 text-muted border border-dashed rounded bg-light">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" id="modal_nomor_invoice" class="form-control f-input fw-bold bg-light text-primary" readonly placeholder="Auto Generated">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="f-label">Referensi / PO</label>
                                                    <input type="text" id="modal_ref_no" class="form-control f-input" placeholder="Contoh: PO-001">
                                                </div>
                                                <div class="col-md-6">
                            ...
                            <div class="card border-0 shadow-sm rounded-3 overflow-hidden mb-4">
                                <div class="card-header bg-white py-3 px-4 border-bottom d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0 fw-bold text-dark text-uppercase small"><i class="fa fa-box me-2 text-primary"></i>Rincian Barang & Jasa</h6>
                                    <div class="d-flex gap-2">
                                        <button type="button" class="btn btn-outline-secondary btn-sm fw-bold px-3 rounded-pill" onclick="openStockModal()">
                                            <i class="fa fa-search me-1"></i> Cari Stok
                                        </button>
                                        <button type="button" class="btn btn-primary btn-sm fw-bold px-3 rounded-pill" onclick="addNewProductRow()">
                                ...
                                <div class="card-body p-4">
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                            ...
                                            <textarea id="modal_keterangan" class="form-control f-text bg-light border-0" rows="3" placeholder="Catatan untuk tim internal..."></textarea>
                                        </div>
                                        <div class="col-md-6">
                        ...
                        <div class="col-lg-3 bg-white border-start h-100 d-flex flex-column shadow-sm z-1">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="d-flex justify-content-between mb-2 align-items-center">
                                        ...
                                        <div style="width: 100px;">
                                            <input type="number" id="modal_diskon_tambahan" class="form-control form-control-sm text-end" value="0" oninput="calculateInvoiceTotal()">
                                        </div>
                                    </div>
                                    <!-- Tax could go here -->
                                </div>
                            ...
                            <div class="p-4 border-top bg-light">
                                <button type="button" class="btn btn-primary w-100 fw-bold py-2 shadow-sm" onclick="saveFullInvoice()">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-body p-0">
                <div class="p-3 bg-light border-bottom">
                    <div class="row g-2">
                        <div class="col-md-4">
                            <input type="text" class="form-control col-filter" data-col="1" placeholder="Cari Kode Produk...">
                        </div>
                        <div class="col-md-4">
                            <input type="text" class="form-control col-filter" data-col="2" placeholder="Cari Nama Produk...">
                        </div>
                        <div class="col-md-4">
                             <input type="text" class="form-control col-filter" data-col="3" placeholder="Cari Kategori...">
                        </div>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0" id="stockTable">
                        <thead class="bg-light sticky-top">
                            <tr>
                                <th width="5%" class="text-center py-3"><input type="checkbox" class="form-check-input" id="checkAllStock" onclick="toggleAllStock(this)"></th>
            ...
            <div class="modal-footer bg-light border-top py-3">
                <div class="d-flex justify-content-between w-100 align-items-center">
                    ...
                    <button type="button" class="btn btn-primary fw-bold px-4 rounded-pill" onclick="addSelectedStocks()">
...
<script>
    ...
    let salesPersons = []; // Will be populated
    ...
    async function openInvoiceModal(id = null, type = null, mode = 'create') {
        ...
        // Populate Mitra Select
        const selMitra = document.getElementById('modal_mitra_id');
        selMitra.innerHTML = '<option value="">Cari Pelanggan...</option>';
        masterMitra.forEach(m => {
            selMitra.insertAdjacentHTML('beforeend', `<option value="${m.id}">${m.nama}</option>`);
        });
    ...
    async function openStockModal() {
        ...
        document.getElementById('stockBodyList').innerHTML = '<tr><td colspan="6" class="text-center p-4"><div class="spinner-border text-primary"></div></td></tr>';
        modal.show();
        ...
        try {
            ...
            document.getElementById('stockBodyList').innerHTML = '<tr><td colspan="6" class="text-center text-danger p-4">Gagal load stock</td></tr>';
        }
    }
    ...
    document.querySelectorAll('.col-filter').forEach(inp => {
        inp.addEventListener('keyup', function() {
            ...
            const filtered = stockCache.filter(item => {
                ...
                if(col == 3) return (item.kategori?.nama_kategori || '').toLowerCase().includes(val);
                return true;
            });
