        ...
        <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    <div class="page-title-box d-md-flex justify-content-between align-items-center mb-3">
                        <div>
                            ...
                            <p class="text-muted mb-0 small">Memantau operasional di <strong>{{ $office->name ?? 'Kantor Belum Dipilih' }}</strong></p>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card bg-welcome-img overflow-hidden border-0 shadow-sm mb-4" style="background: linear-gradient(45deg, #007AFF, #00C6FF);">
                                <div class="card-body p-4">
                                    <div class="row align-items-center">
                                        <div class="col-sm-8">
                                            <h3 class="text-white fw-bold">Selamat Datang, {{ auth()->user()->name }}!</h3>
                                            <p class="text-white-50">Hari ini ada {{ $newOrders }} pesanan baru di kantor {{ $office->name }}. Yuk, selesaikan tugasmu sekarang.</p>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm">
                                <div class="card-body">
                                    ...
                                    <h4 class="fw-bold mb-0 text-dark">{{ $newOrders }} <small class="text-muted font-13">Invoice</small></h4>
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="avatar-sm bg-soft-info text-info rounded-circle me-3 d-flex align-items-center justify-content-center">
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-medium">{{ $tx->nama_pelanggan }}</td>
