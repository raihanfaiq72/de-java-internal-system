                                ...
                                <div class="card  bg-welcome-img overflow-hidden">
                                    <div class="card-body">
                                        <div class="">
                                            ...
                                            <img src="{{url('')}}/assets/images/extra/fund.png" alt="" class=" mb-n4 float-end"
                                                height="107">
                                        </div>
                                    </div>
                                    <!--end card-body-->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class=" text-center mx-auto">
                                    <img src="{{url('')}}/assets/images/extra/rabit.png" alt="" class="d-inline-block" height="105">
                                </div>
                                    ...
                                    <table class="table mb-0">
                                        <tbody>
                                            <tr class="">
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/flags/us_flag.jpg"
                                            ...
                                            <tr class="">
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/flags/spain_flag.jpg"
                                                            class="me-2 align-self-center thumb-sm rounded-circle"
                                                            alt="...">
                                            ...
                                            <tr class="">
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/flags/french_flag.jpg"
                                                            class="me-2 align-self-center thumb-sm rounded-circle"
                                                            alt="...">
                                            ...
                                            <tr class="">
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/flags/germany_flag.jpg"
                                                            class="me-2 align-self-center thumb-sm rounded-circle"
                                                            alt="...">
                                            ...
                                            <tr class="">
                                                <td class="px-0 pb-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/flags/baha_flag.jpg"
                                                            class="me-2 align-self-center thumb-sm rounded-circle"
                                                            alt="...">
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/logos/lang-logo/chatgpt.png" height="40"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/logos/lang-logo/gitlab.png" height="40"
                                                            class="me-3 align-self-center rounded" alt="...">
                                                        <div class="flex-grow-1 text-truncate">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/logos/lang-logo/nextjs.png" height="40"
                                                            class="me-3 align-self-center rounded" alt="...">
                                                        <div class="flex-grow-1 text-truncate">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/logos/lang-logo/vue.png" height="40"
                                                            class="me-3 align-self-center rounded" alt="...">
                                                        <div class="flex-grow-1 text-truncate">
                                                            <h6 class="m-0">Vue</h6>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/logos/lang-logo/symfony.png" height="40"
                                                            class="me-3 align-self-center rounded" alt="...">
                                                        <div class="flex-grow-1 text-truncate">
                                    ...
                                    <table class="table mb-0">
                                        <tbody>
                                            <tr class="">
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/users/avatar-1.jpg" height="36"
                                            ...
                                            <tr class="">
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/users/avatar-2.jpg" height="36"
                                                            class="me-2 align-self-center rounded" alt="...">
                                                        <div class="flex-grow-1 text-truncate">
                                            ...
                                            <tr class="">
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/users/avatar-3.jpg" height="36"
                                                            class="me-2 align-self-center rounded" alt="...">
                                                        <div class="flex-grow-1 text-truncate">
                                            ...
                                            <tr class="">
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/users/avatar-4.jpg" height="36"
                                                            class="me-2 align-self-center rounded" alt="...">
                                                        <div class="flex-grow-1 text-truncate">
                                            ...
                                            <tr>
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/users/avatar-5.jpg" height="36"
                                                            class="me-2 align-self-center rounded" alt="...">
                                                        <div class="flex-grow-1 text-truncate">
                                            ...
                                            <tr class="">
                                                <td class="px-0">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{url('')}}/assets/images/users/avatar-9.jpg" height="36"
                                                            class="me-2 align-self-center rounded" alt="...">
                                                        <div class="flex-grow-1 text-truncate">
                                                            <h6 class="m-0 text-truncate">Steven Sharp </h6>
                                                            <a href="#"
