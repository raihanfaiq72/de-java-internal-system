                ...
                <div class="row mb-4 g-3 align-items-end">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="input-group shadow-sm">
                            ...
                            <input type="date" id="filter-date-from" class="form-control border-0"
                                onchange="loadStockDashboard()">
                            <span class="input-group-text bg-white border-0">Sampai:</span>
                            <input type="date" id="filter-date-to" class="form-control border-0"
                                onchange="loadStockDashboard()">
                        </div>
                    </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="tab-dashboard" role="tabpanel">
                                        <div class="row g-4 mb-4">
                                            <div class="col-md-3">
                                                <div
                                                    class="card border-0 shadow-sm bg-info-subtle border-start border-4 border-info">
                                                    <div class="card-body">
                                                        <h6 class="text-info fw-bold mb-2">Order untuk Diterima</h6>
                                                        <h3 id="stat-pending-receive" class="fw-bold">0.00</h3>
                                                        <a href="{{ route('purchase') }}"
                                                            class="small text-decoration-none text-info">Lihat Detail <i
                                                                class="iconoir-arrow-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div
                                                    class="card border-0 shadow-sm bg-warning-subtle border-start border-4 border-warning">
                                                    <div class="card-body">
                                                        <h6 class="text-warning fw-bold mb-2">Order untuk Dikirim</h6>
                                                        <h3 id="stat-pending-ship" class="fw-bold">0.00</h3>
                                                        <a href="{{ route('sales') }}"
                                                            class="small text-decoration-none text-warning">Lihat Detail <i
                                                                class="iconoir-arrow-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div
                                                    class="card border-0 shadow-sm bg-primary-subtle border-start border-4 border-primary">
                                                    <div class="card-body">
                                            ...
                                            <div class="col-md-3">
                                                <div
                                                    class="card border-0 shadow-sm bg-success-subtle border-start border-4 border-success">
                                                    <div class="card-body">
                                    ...
                                    <div class="tab-pane fade" id="tab-persediaan" role="tabpanel">
                                        <div class="row g-2 mb-3 align-items-end">
                                            <div class="col-md-3">
                                                ...
                                                <select id="filter-stock-location" class="form-select form-select-sm"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" id="filter-stock-search"
                                                    class="form-control form-control-sm" placeholder="Ketik pencarian..."
                                                    onkeyup="loadStockData()">
                                            </div>

                                            <div class="col-md-2">
                                                <label class="small fw-bold text-muted">Kategori</label>
                                                <select id="filter-stock-kategori" class="form-select form-select-sm"
                                                    onchange="loadStockData()">
                                        ...
                                        <div id="persediaan-empty-state" class="text-center py-5 d-none">
                                            ...
                                            <p class="text-muted">Silahkan pilih lokasi terlebih dahulu untuk melihat stok.
                                            </p>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center px-2 mt-3"
                                            ...
                                            <nav>
                                                <ul class="pagination pagination-sm mb-0" id="stock-pagination-container">
                                                </ul>
                                            </nav>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-sm table-bordered align-middle">
                                                ...
                                                <tbody id="location-table-body">
                                                    <tr>
                                                        <td colspan="3" class="text-center text-muted">Memuat data lokasi...
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-sm table-bordered">
                                                ...
                                                <tbody id="mutation-table-body">
                                                    <tr>
                                                        <td colspan="6" class="text-center text-muted">Memuat Riwayat...
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="small text-muted mb-3">Menampilkan batch stok masuk yang masih memiliki sisa (belum
                        terjual/keluar sepenuhnya). Sistem menggunakan metode First-In-First-Out.</p>
                    <div class="table-responsive">
...
@push('js')
    ...
    <script>
        ...
        async function deleteLocation(id) {
            if (!await macConfirm('Hapus lokasi', 'Hapus lokasi ini? Semua data stok di lokasi ini tidak akan terhapus tapi mungkin sulit diakses.')) return;
            const res = await fetch(`${API_LOCATION_URL}/${id}`, {
                method: 'DELETE',
