                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button class="btn btn-primary" onclick="window.location.href='{{ route('report.stock') }}'">
                        ...
                        <div class="card border-0 shadow-sm h-100 position-relative overflow-hidden">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex justify-content-between small text-muted">
                                    <span>Total Item Fisik: <span id="stat-total-qty" class="fw-bold text-dark">0</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white border-bottom pt-3 pb-0">
                        <ul class="nav nav-tabs card-header-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active fw-bold py-3 text-primary" data-bs-toggle="tab" href="#tab-persediaan" role="tab">
                                    <i class="iconoir-packages me-2"></i>Daftar Stok
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fw-bold py-3 text-muted" data-bs-toggle="tab" href="#tab-lokasi" role="tab">
                                    <i class="iconoir-map-pin me-2"></i>Lokasi & Gudang
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fw-bold py-3 text-muted" data-bs-toggle="tab" href="#tab-dokumen" role="tab">
                                    <i class="iconoir-history me-2"></i>Riwayat Mutasi
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="tab-persediaan" role="tabpanel">
                                        ...
                                        <div class="row g-3 align-items-center">
                                            <div class="col-md-4">
                                                <div class="form-floating">
                                                    <input type="text" id="filter-stock-search" class="form-control border-0 shadow-none" placeholder="Cari..." onkeyup="handleFilterChange()">
                                                    <label for="filter-stock-search">Cari Nama Produk / SKU</label>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-floating">
                                                    <select id="filter-stock-location" class="form-select border-0 shadow-sm" onchange="handleFilterChange()">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-floating">
                                                    <select id="filter-stock-kategori" class="form-select border-0 shadow-sm" onchange="handleFilterChange()">
                                            ...
                                            <div class="col-md-2">
                                                 <div class="form-floating">
                                                    <select id="filter-stock-status" class="form-select border-0 shadow-sm" onchange="handleFilterChange()">
                                            ...
                                            <div class="col-md-2 text-end">
                                                <div class="btn-group shadow-sm w-100 h-100">
                                                    <button class="btn btn-white text-muted h-100 d-flex align-items-center justify-content-center" title="Export Excel" onclick="exportStock()"><i class="iconoir-download fs-4"></i></button>
                                                    <button class="btn btn-white text-muted h-100 d-flex align-items-center justify-content-center" title="Print" onclick="printStock()"><i class="iconoir-printer fs-4"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <!-- Pagination -->
                                <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top" id="persediaan-pagination-wrapper">
                                ...
                                <div class="table-responsive rounded border-0 shadow-sm">
                                    <table class="table table-hover align-middle mb-0">
                                        ...
                                        <tbody id="location-table-body" class="bg-white">
                                            <tr>
                                                <td colspan="3" class="text-center py-5 text-muted">Memuat data lokasi...</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="card bg-light border-0 mb-4">
                                    <div class="card-body p-3">
                                        <div class="row g-3 align-items-center">
                                            <div class="col-md-3">
                                                <div class="form-floating">
                                                    <input type="date" id="filter-mutation-start" class="form-control border-0 shadow-none" onchange="loadMutationData()">
                                                    <label for="filter-mutation-start">Dari Tanggal</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-floating">
                                                    <input type="date" id="filter-mutation-end" class="form-control border-0 shadow-none" onchange="loadMutationData()">
                                                    <label for="filter-mutation-end">Sampai Tanggal</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-floating">
                                                    <select id="filter-mutation-type" class="form-select border-0 shadow-sm" onchange="loadMutationData()">
                                            ...
                                            <div class="col-md-3">
                                                 <div class="form-floating">
                                                    <select id="filter-mutation-location" class="form-select border-0 shadow-sm" onchange="loadMutationData()">
                                                        <option value="">Semua Lokasi</option>
                                                    </select>
